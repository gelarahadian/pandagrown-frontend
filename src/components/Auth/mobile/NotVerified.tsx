...
interface CreateNotVerifiedProps {
  isOpen: boolean,
}
...
function NotVerified({ isOpen }: CreateNotVerifiedProps) {
  ...
  return (
    <div className="text-center">
      ...
      <label className="text-3xl block font-bold mt-14">Please verify your account.</label>
