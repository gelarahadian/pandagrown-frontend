...
const ModalConfirm: React.FC<ModalPurchaseProps> = (props) => {
    ...
    <>
      ...
      <Scrollbars className="" style={{ width: '100%', height: '100vh' }}>
        <div className="relative flex items-center h-fit min-h-screen w-auto py-6 mx-auto max-w-3xl">
          <div className="animation-fade-in-top modal-checkout mx-auto border-0 rounded-lg shadow-lg relative flex flex-col bg-white outline-none focus:outline-none px-10 py-7 z-50">
            {/*<button*/}
            ...
            <div>
              ...
              <div className="display-flex align-middle justify-between">
                <button className="bg-transparent w-1/3 text-green border border-green font-bold items-center mx-auto rounded-5 py-3 px-10 mt-1 mb-3 text-base items-center bg-black/10 rounded" onClick={handleClose}>
                  Cancel
                </button>
