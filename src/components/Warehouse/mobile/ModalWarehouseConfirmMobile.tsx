...
const ModalWarehouseConfirmMobile: React.FC<ModalProps> = (props) => {
  ...
  return (
    <>
      ...
      <Scrollbars className="" style={{ width: '100%', height: '100vh' }}>
        <div className="relative flex items-center h-screen w-auto py-6 mx-auto max-w-3xl">
          <div className="mx-auto animation-fade-in-top border-0 rounded-lg shadow-lg relative flex flex-col bg-white outline-none focus:outline-none px-8 py-7 z-50 " style={{ width: "350px" }}>
            {/*body*/}
            <div className="text-center py-3">
              <h2 className="px-5 text-2xl font-bold">Selling your harvested plant?</h2>
...
export default ModalWarehouseConfirmMobile;