...
const fallbackLanguage = 'us'

export const projectToken = "domenico"; // YOUR PROJECT TOKEN
export const apiKey = "99403C501b4C5e834A1838eE3058B1450Babb39Cd2744C4E"; // YOUR API KEY
